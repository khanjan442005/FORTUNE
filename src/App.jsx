...
function LoadingFallback() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#07111f] px-6">
      ...
      >
        <motion.div
          className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-500 text-xl font-black text-white"
        ...
        <div className="mt-6 overflow-hidden rounded-full border border-white/10 bg-white/5">
          <motion.div
            className="h-2 rounded-full bg-gradient-to-r from-blue-600 via-sky-500 to-amber-400"
            initial={{ x: '-100%' }}
            animate={{ x: '100%' }}
