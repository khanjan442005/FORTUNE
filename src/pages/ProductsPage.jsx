    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <motion.span
          ...
          className="inline-block px-4 py-2 glass rounded-full text-cyan-400 text-sm font-medium mb-6"
        >
          {badge}
        </motion.span>
        <motion.h1
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {trustBadges.map((badge, index) => (
                  <motion.div
                    ...
                    className="glass rounded-2xl p-6 text-center group hover:border-cyan-500/30 transition-colors"
                  >
                    <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {categories.map((cat, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="glass rounded-2xl p-8 group hover:border-cyan-500/30 transition-all hover:-translate-y-1"
                  >
                    <div className="w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="px-2 py-0.5 bg-cyan-500/20 text-cyan-400 text-xs rounded-full">{cat.count}</span>
                    </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {processSteps.map((step, index) => (
                  <motion.div
                    ...
                    className="relative"
                  >
                    <div className="glass rounded-2xl p-8 h-full relative overflow-hidden group hover:border-cyan-500/30 transition-colors">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-wrap gap-4 justify-center">
                    ...
                    <Link to="/showcase" className="outline-button">
