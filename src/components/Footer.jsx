...
const footerLinks = {
  products: [
    { label: "Sliding Windows", to: sectionLinks.products },
    { label: "Casement Windows", to: sectionLinks.products },
    { label: "Bay Windows", to: sectionLinks.products },
    { label: "Tilt & Turn", to: sectionLinks.products },
    { label: "UPVC Windows", to: sectionLinks.products },
    { label: "Glass Doors", to: sectionLinks.products },
  ],
  company: [
    { label: "About Us", to: sectionLinks.about },
    { label: "Our Team", to: sectionLinks.about },
    { label: "Careers", to: sectionLinks.contact },
    { label: "Project Gallery", to: sectionLinks.gallery },
    { label: "Testimonials", to: sectionLinks.testimonials },
    { label: "Contact", to: sectionLinks.contact },
  ],
  support: [
    { label: "FAQ", to: sectionLinks.contact },
    { label: "Warranty", to: sectionLinks.features },
    { label: "Maintenance", to: sectionLinks.contact },
    { label: "Installation", to: sectionLinks.features },
    { label: "Shipping", to: sectionLinks.contact },
    { label: "Returns", to: sectionLinks.contact },
  ],
};
