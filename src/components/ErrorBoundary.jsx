      ...
      return (
        <div className="flex min-h-screen items-center justify-center bg-[#030712] px-6">
          <div className="glass w-full max-w-xl rounded-3xl border border-white/10 p-8 text-center">
            <p className="text-sm uppercase tracking-[0.28em] text-cyan-300/80">Runtime Error</p>
            ...
            <button
              ...
              className="mt-6 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-5 py-2 text-sm font-medium text-cyan-200 transition-colors hover:border-cyan-300/40 hover:text-white"
            >
              Try Again
            </button>
          </div>
