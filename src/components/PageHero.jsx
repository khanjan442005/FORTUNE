  ...
  return (
    <section className="relative overflow-hidden px-6 pb-14 pt-28 md:pb-24 md:pt-44">
      ...
      <ParallaxLayer speed={0.12} className="absolute -left-20 top-14 h-64 w-64">
        <div className="h-full w-full rounded-full bg-blue-500/10 blur-[150px]" />
      </ParallaxLayer>
      <ParallaxLayer speed={0.18} direction="horizontal" className="absolute right-0 top-10 h-72 w-72">
        <div className="h-full w-full rounded-full bg-amber-500/10 blur-[180px]" />
      </ParallaxLayer>
      <div className="container mx-auto max-w-[1400px]">
        ...
        >
          <motion.span
            ...
            className="fx-chip inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-blue-100 md:px-5 md:py-2.5 md:text-base"
          >
          ...
          <motion.div
            ...
            className={`mt-10 h-px bg-gradient-to-r from-transparent via-blue-400/45 to-transparent ${
